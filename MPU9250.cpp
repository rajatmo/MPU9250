...
/*
*===============================================================
*			The bare minimum: read/write registers
*
*===============================================================
*/
...
int MPU9250::readAK8963Registers(uint8_t subAddress, uint8_t count,
	uint8_t* dest) {
